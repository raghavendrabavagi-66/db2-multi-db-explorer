"""ASGI entry for Streamlit 1.53+ with the Object Explorer search API route."""
...
# Streamlit pages live at the repo root (parent of db2_explorer/).
_MAIN_SCRIPT = str(Path(__file__).resolve().parent.parent / "app.py")
